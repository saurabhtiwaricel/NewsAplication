...
#define NEWS_API_URL @"https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=3e57d784fd8144d4b4a67fe0feb2bdfd"
...
- (void)viewDidLoad {
    ...
    self.dateLabel.text = [NSString stringWithFormat:@"Business News of %@", dateString];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    businessTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"business" forIndexPath:indexPath];
